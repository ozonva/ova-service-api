...
// Source: github.com/ozonva/ova-service-api/internal/flusher (interfaces: Flusher)
...
func (m *MockFlusher) Flush(arg0 context.Context, arg1 []models.Service) []models.Service {
	m.ctrl.T.Helper()
